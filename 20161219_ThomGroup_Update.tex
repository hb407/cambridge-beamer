...
\begin{frame}{Holomorphic RHF: \ce{H2} STO-3G}
 \begin{columns}
   ...
   \begin{column}{0.7\textwidth}
     \begin{center}
     \hspace{2em}\onslide<1->{\movie{\includegraphics[width=0.9\textwidth]{20161219_ThomGroup_Update/RHF_HZ_0-00_400_cont.eps}}{20161219_ThomGroup_Update/R_vary_Z_0-00_cont_animation.mp4}}
     \end{center} 
   \end{column}
 \end{columns}
...
\begin{frame}{Holomorphic UHF: \ce{H2} STO-3G}
\vspace{-0.9em}
  \begin{center}
...
\begin{frame}{Holomorphic UHF: \ce{H4} STO-3G}
\vspace{-0.9em}
  \begin{center}
